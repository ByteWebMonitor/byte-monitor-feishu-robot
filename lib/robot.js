...
const BotClient = require('feishu_clientbot');

module.exports = Robot;
module.exports.default = Robot;
 ...
 */
Robot.prototype.sendImage = function (img) {
    const data = {
        msg_type: "image",
        content: {
            image_key: img
...
Robot.prototype.send = function(data) {
    ...
    return BotClient.post(this.webhook, { body: data });
}